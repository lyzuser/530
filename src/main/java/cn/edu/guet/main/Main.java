...
public class Main {
    ...
    JTable table;//将数据以表格的形式呈现给用户
    JScrollPane jscrollpane = new JScrollPane();//滑动
    ...
    public Main() {
        ...
        jPanel = (JPanel) jFrame.getContentPane();//jFrame设置为jPanel的内容面板
        ...
        item01.addActionListener(e -> {
            ...
            r.setHorizontalAlignment(JLabel.CENTER);//表格居中
